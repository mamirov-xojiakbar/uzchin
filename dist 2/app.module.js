    ...
    (0, common_1.Module)({
        imports: [
            sequelize_1.SequelizeModule.forRoot({
                ...
                password: 'abubakiir7',
                database: 'uzchin',
                models: [category_model_1.Category, product_model_1.Product, user_model_1.User, cart_item_model_1.CartItem],
                autoLoadModels: true,
                synchronize: true,
            }),
            sequelize_1.SequelizeModule.forFeature([category_model_1.Category, product_model_1.Product, user_model_1.User, cart_item_model_1.CartItem]),
